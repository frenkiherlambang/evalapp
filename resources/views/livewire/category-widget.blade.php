<div>
    {{-- {{ $categories['name'] }}<br /> --}}
    {{-- @foreach ($categories['random_questions'] as $question) --}}
        ...
        <div class="relative -space-y-px rounded-md bg-white">
            ...
            <ol class="flex justify-center gap-1 text-xs font-medium">
                ...
                @foreach ($surveyQuestionData['random_questions'] as $question)
                    ...
                    {{  $surveyQuestionData['random_questions'][$loop->index] }}
                    @if($surveyQuestionData['random_questions'][$loop->index] == $currentQuestion)
